...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/button.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
exports.refs = refs;
},{}],"js/infinityPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.infinityPage = void 0;
const infinityPage = {
  heightRedLine: 100,
    ...
    return () => {
      if (!this.isScrollingRightNow) {
        ...
        window.requestAnimationFrame(() => {
          //reset
          this.isScrollingRightNow = false; //check if we reached the bottom

          if (window.innerHeight + window.scrollY >= document.body.scrollHeight - this.heightRedLine) {
            this.fire();
          }
        });
      }
...
exports.infinityPage = infinityPage;
...
var SimpleLightbox = /*#__PURE__*/function () {
  function SimpleLightbox(elements, options, customValue) {
    var _this = this;
    ...
    if (customValue) this.open(customValue)
    console.log('yeah')
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/gallery.js":[function(require,module,exports) {
"use strict";
...
var _infinityPage = require("./infinityPage.js");
...
const gallery = {
  placeForRender: _refs.refs.gallery,
  simpleLightbox: null,
  simpleLightbox: new _simplelightbox.default('.gallery .photo-card a', {
    captionsData: 'alt',
    captionsDelay: 150,
    additionalHtml: '<button class="button-33 download-button download-button-modal" id="modalSaveBtn" data-downloaded="true" data-modal="true">download me</button>'
  }),
  render: function (data) {
    ...
    this.placeForRender.insertAdjacentHTML('beforeEnd', markup); // refs.buttonLoadMore.disabled = false;
  ...
  refreshGalleryModule: function () {
    ...
    if (this.simpleLightbox.currentImage) {
      ...
      // );
      let theImg = this.simpleLightbox.elements[this.simpleLightbox.currentImageIndex]; // console.log(theImg)

      this.simpleLightbox.destroy();
      this.simpleLightbox = new _simplelightbox.default('.gallery .photo-card a', {
        captionsData: 'alt',
        captionsDelay: 150,
        additionalHtml: '<button class="button-33 download-button download-button-modal" id="modalSaveBtn" data-downloaded="true" data-modal="true">download me</button>'
      }, theImg), this.refreshEvents(); // setTimeout(function () {
  ...
  refreshEvents() {
    ...
    this.simpleLightbox.on('changed.simplelightbox', gallery.checkApprochingToCurrentLastImg); // this.simpleLightbox.on('prev.simplelightbox', this.checkOpenLast);
    // this.simpleLightbox.on('closed.simplelightbox', function () {
  ...
  checkApprochingToCurrentLastImg() {
    if (!_infinityPage.infinityPage.funtionToDo) if (!_infinityPage.infinityPage.funtionToDo) return; // const { currentImageIndex } = gallery.simpleLightbox;
    ...
    const {
      ...
      currentImageIndex
    } = gallery.simpleLightbox; // console.log(length - numberForFire, ' >=', currentImageIndex, gallery.simpleLightbox);

    if (length - numberForFire <= currentImageIndex) {
      // console.log(true);
      _infinityPage.infinityPage.fire();
    }
  },
  ...
  checkOpenLast() {
    ...
    if (currentImageIndex === 0) _infinityPage.infinityPage.fire();
  }

};
exports.gallery = gallery;
},{"./refs":"js/refs.js","./infinityPage.js":"js/infinityPage.js","simplelightbox":"../node_modules/simplelightbox/dist/simple-lightbox.modules.js","simplelightbox/dist/simple-lightbox.min.css":"../node_modules/simplelightbox/dist/simple-lightbox.min.css"}],"js/saveImg.js":[function(require,module,exports) {
"use strict";
...
async function saveImage(e, el) {
  if (!e.target.dataset.downloaded) return;
  const imgEl = e.target.dataset.modal ? _gallery.gallery.simpleLightbox.elements[_gallery.gallery.simpleLightbox.currentImageIndex].previousElementSibling : e.target;
  const image = await fetch(imgEl.dataset.href);
  const imageBlog = await image.blob();
  const imageURL = URL.createObjectURL(imageBlog);
  const link = _refs.refs.elementForDownloadImgs;
  link.href = imageURL;
...
},{"./refs":"js/refs.js","./gallery":"js/gallery.js"}],"js/themeChanger.js":[function(require,module,exports) {
"use strict";
...
function changeTheme(e, userTheme) {
  const el = _refs.refs.themeChanger;
  const theme = userTheme ? userTheme : el.dataset.theme;

  if (userTheme) {
    if (userTheme === 'light') setLight(el);else setDark(el);
    return;
  }

  if (theme === 'light') setDark(el);else setLight(el);
...
_refs.refs.themeChanger.dataset.theme = userTheme;
document.body.style.backgroundColor = SETTINGS[userTheme];
changeTheme(undefined, userTheme);

_refs.refs.themeChanger.addEventListener('click', changeTheme);
},{"./refs":"js/refs.js"}],"../node_modules/notiflix/build/notiflix-notify-aio.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/modalWaitLoad.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.modalWait = void 0;
const modalWait = {
...
},{}],"js/searchMechanics.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchMechanics = void 0;
...
var _modalWaitLoad = require("./modalWaitLoad");
...
const searchMechanics = {
  ...
  fetchPhotos: async function (userQuery) {
    ...
    this.page += 1; // const response = await fetch(urlQuery);
    // const dataFromBackEnd = await response.json();
    // this.lastRespons = dataFromBackEnd;

    const response = await axios.get(urlQuery);
    this.lastRespons = response.data; //check for bad request

    if (response.data.total === 0) return 1;
    return response.data;
  },
  checkRechedEnd: function () {
    if (this.per_page * (this.page - 1) < this.lastRespons.total) return; // console.log('THE END');
    // refs.buttonLoadMore.disabled = true;
...
},{"./refs":"js/refs.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js","axios":"../node_modules/axios/index.js","./modalWaitLoad":"js/modalWaitLoad.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
require("./js/saveImg.js");

require("./js/themeChanger");

var _refs = require("./js/refs.js");

var _searchMechanics = require("./js/searchMechanics.js");

var _gallery = require("./js/gallery.js");

var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");

var _infinityPage = require("./js/infinityPage.js");

var _modalWaitLoad = require("./js/modalWaitLoad.js");

async function clickSearch(e) {
  e.preventDefault();
  if (e.target.nodeName !== 'FORM') return;

  _infinityPage.infinityPage.clear();

  _gallery.gallery.clear();

  const {
    value
  } = e.currentTarget.searchQuery;

  if (!value) {
    _notiflixNotifyAio.Notify.info(`Hey! Please fill in something in the fild. Thanks.`, {
      timeout: 3000
    });
  ...
  _notiflixNotifyAio.Notify.info(`Hooray! We found ${_searchMechanics.searchMechanics.lastRespons.total} images.`, {
    timeout: 5000
  });
...
async function beginSearch(query) {
  ...
  _modalWaitLoad.modalWait.show();

  return await _searchMechanics.searchMechanics.fetchPhotos(query).then(response => {
    if (response === 1) throw error;
    if (response === 0) return;
    const data = response.hits;

    _gallery.gallery.render(data);

    if (query && _searchMechanics.searchMechanics.checkRechedEnd()) {
      _modalWaitLoad.modalWait.hide();

      return true;
    }

    _infinityPage.infinityPage.init(loadMore, _refs.refs.buttonLoadMore);
    ...
    // console.error(error);
    _notiflixNotifyAio.Notify.warning('Sorry, there are no images matching your search query. Please try again.', {
      timeout: 6000
    });
...
function scrollAfterSearch() {
  ...
  const {
    top,
    bottom
  } = document.querySelector('.search-container').firstElementChild.getBoundingClientRect();
...
_refs.refs.form.addEventListener('submit', clickSearch); // refs.buttonLoadMore.addEventListener('click', loadMore);
},{"./css/styles.css":"css/styles.css","./css/button.css":"css/button.css","./js/saveImg.js":"js/saveImg.js","./js/themeChanger":"js/themeChanger.js","./js/refs.js":"js/refs.js","./js/searchMechanics.js":"js/searchMechanics.js","./js/gallery.js":"js/gallery.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js","./js/infinityPage.js":"js/infinityPage.js","./js/modalWaitLoad.js":"js/modalWaitLoad.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
